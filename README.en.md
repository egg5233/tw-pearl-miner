...
> **Latest (v1.5.0):** ~25% lower upload bandwidth — shares now use a more efficient binary submit format, negotiated automatically with the pool and fully backward-compatible (no config change). [Full changelog ↗](https://github.com/egg5233/tw-pearl-miner/releases)
...
|---|---|---|
| **Windows** | ≥ 580.88 | [tw-pearl-miner-windows.zip](https://github.com/egg5233/tw-pearl-miner/releases/download/v1.5.0/tw-pearl-miner-windows.zip) |
| **Linux** (desktop / server) | ≥ 580.65 | [tw-pearl-miner-linux.tar.gz](https://github.com/egg5233/tw-pearl-miner/releases/download/v1.5.0/tw-pearl-miner-linux.tar.gz) · [.zip](https://github.com/egg5233/tw-pearl-miner/releases/download/v1.5.0/tw-pearl-miner-linux.zip) |
| **HiveOS** | ≥ 580.65 | [tw-pearl-miner-1.5.0.tar.gz](https://github.com/egg5233/tw-pearl-miner/releases/download/v1.5.0/tw-pearl-miner-1.5.0.tar.gz) |
| **Linux** — older driver | 570.26–580 | [tw-pearl-miner-1.5.0-cuda12.tar.gz](https://github.com/egg5233/tw-pearl-miner/releases/download/v1.5.0/tw-pearl-miner-1.5.0-cuda12.tar.gz) |
| **HiveOS** — older driver | 570.26–580 | [tw-pearl-miner-1.5.0.c12.tar.gz](https://github.com/egg5233/tw-pearl-miner/releases/download/v1.5.0/tw-pearl-miner-1.5.0.c12.tar.gz) |
...
wget https://github.com/egg5233/tw-pearl-miner/releases/download/v1.5.0/tw-pearl-miner-linux.tar.gz

    ...
    "items": [
        {
            ...
            "miner_config": {
                "algo": "pearlhash",
                "install_url": "https://github.com/egg5233/tw-pearl-miner/releases/download/v2.2.4/tw-pearl-miner-2.2.4.tar.gz",
...
2. **添加自定义矿工**（飞行表 → Miner → `+` → *Setup Miner Config* → **Custom**）：
   ...
   - **安装 URL（Installation URL）：**
     ```
     https://github.com/egg5233/tw-pearl-miner/releases/download/v2.2.4/tw-pearl-miner-2.2.4.tar.gz
     ```
     （也可用 `https://github.com/egg5233/tw-pearl-miner/releases/latest/download/tw-pearl-miner-2.2.4.tar.gz`）
...
- **卡在 570–580 驱动（上不了 CUDA 13）？** 改用 **CUDA-12.8** 版安装包 —— 速度相同，可在驱动
  ...
  ```
  https://github.com/egg5233/tw-pearl-miner/releases/download/v2.2.4/tw-pearl-miner-2.2.4.c12.tar.gz
  ```

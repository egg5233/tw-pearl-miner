    ...
    "items": [
        {
            ...
            "miner_config": {
                "algo": "pearlhash",
                "install_url": "https://github.com/egg5233/tw-pearl-miner/releases/download/v2.3.2/tw-pearl-miner-2.3.2.tar.gz",
...
- **`install_url`** pins **v2.3.2** — bump it to the latest release tag when a newer version ships.
...
2. **Add a Custom Miner** (Flight Sheet → Miner → `+` → *Setup Miner Config* → **Custom**):
   ...
   - **Installation URL:**
     ```
     https://github.com/egg5233/tw-pearl-miner/releases/download/v2.3.2/tw-pearl-miner-2.3.2.tar.gz
     ```
     (or `https://github.com/egg5233/tw-pearl-miner/releases/latest/download/tw-pearl-miner-2.3.2.tar.gz`)
...
- **Stuck on a 570–580 driver (no CUDA 13)?** Use the **CUDA-12.8** package instead — same speed, runs
  ...
  ```
  https://github.com/egg5233/tw-pearl-miner/releases/download/v2.3.2/tw-pearl-miner-2.3.2.c12.tar.gz
  ```

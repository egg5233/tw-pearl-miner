...
2. **Add a Custom Miner** (Flight Sheet → Miner → `+` → *Setup Miner Config* → **Custom**):
   ...
   - **Installation URL:**
     ```
     https://github.com/egg5233/tw-pearl-miner/releases/download/v1.6.0/tw-pearl-miner-1.6.0.tar.gz
     ```
     (if you publish GitHub Releases, you can instead use
     `https://github.com/egg5233/tw-pearl-miner/releases/latest/download/tw-pearl-miner-1.6.0.tar.gz`)
...
- **Stuck on driver 570–580 (can't reach CUDA 13)?** Use the **CUDA-12.8** custom-miner package as
  ...
  ```
  https://github.com/egg5233/tw-pearl-miner/releases/download/v1.6.0/tw-pearl-miner-1.6.0.c12.tar.gz
  ```

...
| **Linux**（桌面 / 伺服器） | ≥ 580.65 | [tw-pearl-miner-linux.tar.gz](https://github.com/egg5233/tw-pearl-miner/releases/download/v2.0.3/tw-pearl-miner-linux.tar.gz) |
...
| **Linux** —— 舊驅動 | 570.26–580 | [tw-pearl-miner-2.0.3-cuda12.tar.gz](https://github.com/egg5233/tw-pearl-miner/releases/download/v2.0.3/tw-pearl-miner-2.0.3-cuda12.tar.gz) |
| **HiveOS** —— 舊驅動 | 570.26–580 | [tw-pearl-miner-2.0.3.c12.tar.gz](https://github.com/egg5233/tw-pearl-miner/releases/download/v2.0.3/tw-pearl-miner-2.0.3.c12.tar.gz) |

## 快速開始

**只想挖礦？複製下面，填入你自己的錢包地址，執行即可：**

```bash
# Linux / HiveOS（在解壓後的資料夾內執行）
...
把 YOUR_WALLET 換成你的 prl1... 收款地址。".worker" 只是你的礦機名，可改成任意名稱。就這樣，挖礦程式會自動識別你的顯示卡並開始挖礦。

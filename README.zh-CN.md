...
|---|---|---|---|---|---|---|---|
| 5090 | 370@575w | 4090 | 299.3@450w | 3090 | 122.0@367w | A100 | TBD |
| 5090 | 330@505w | 4080S | 189.6@320w | 3080Ti | 112.6@336w | H100 | TBD |
| 5080 | 210@339w | 4080S | 185.0@319w | 3080 | 111.0@331w | B200 | TBD |
| 5070Ti | 173.9@300w | 4070TS | 158.2@285w | 3070Ti | 78.4@310w | PRO6000 | TBD |
| 5070 | 120@250w | 4070Ti | 151.1@285w | 3070 | 75.0@239w |  |  |
| 5060Ti | 89.5@180w | 4070S | 129.4@220w | 3060Ti | 58.0@199w |  |  |
| 5060 | 70@145w | 4070 | 114.5@200w | 3060 | 45.7@170w |  |  |
|  | | 4060Ti | 79.6@165w |  |  |  |  |
|  |  | 4060 | 56.4@115w |  |  |  |  |
...
- **NVIDIA 驱动 ≥ 570.26（Linux，CUDA 12 版本）/ ≥ 580.88（Windows，CUDA 13 版本）**。无需安装其他东西 —— CUDA 运行时已打包在内。
- 矿池连接方式（TLS / 明文）取决于你的 `--pool` 协议前缀（见上面命令行说明）。

> **驱动太旧？** 如果矿工一启动就退出并报 `cudaGetDeviceCount returned 0` 或 `pk_init failed`，说明驱动低于最低要求 —— 请**更新驱动**（这是驱动版本问题，不是显卡问题）。用 `nvidia-smi` 查看。

...
| **Linux** (desktop / server) | ≥ 580.65 | [tw-pearl-miner-linux.tar.gz](https://github.com/egg5233/tw-pearl-miner/releases/download/v2.1.10/tw-pearl-miner-linux.tar.gz) |
| **Linux** — older driver | 570.26–580 | [tw-pearl-miner-2.1.10-cuda12.tar.gz](https://github.com/egg5233/tw-pearl-miner/releases/download/v2.1.10/tw-pearl-miner-2.1.10-cuda12.tar.gz) |
| **HiveOS** — older driver | 570.26–580 | [tw-pearl-miner-2.1.10.c12.tar.gz](https://github.com/egg5233/tw-pearl-miner/releases/download/v2.1.10/tw-pearl-miner-2.1.10.c12.tar.gz) |

...
| **Linux** (desktop / server) | ≥ 580.65 | [tw-pearl-miner-linux.tar.gz](https://github.com/egg5233/tw-pearl-miner/releases/download/v2.0.4/tw-pearl-miner-linux.tar.gz) |
| **Linux** — older driver | 570.26–580 | [tw-pearl-miner-2.0.4-cuda12.tar.gz](https://github.com/egg5233/tw-pearl-miner/releases/download/v2.0.4/tw-pearl-miner-2.0.4-cuda12.tar.gz) |
| **HiveOS** — older driver | 570.26–580 | [tw-pearl-miner-2.0.4.c12.tar.gz](https://github.com/egg5233/tw-pearl-miner/releases/download/v2.0.4/tw-pearl-miner-2.0.4.c12.tar.gz) |

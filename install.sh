...
URL="https://github.com/egg5233/tw-pearl-miner/releases/download/v2.0.3/tw-pearl-miner-linux.tar.gz"
...
echo
echo "Installed. Next:"
echo "  1) edit $DEST/start.sh and set WALLET (your prl1... address) and POOL (your mining pool)"
